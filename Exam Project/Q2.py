...
class CareerClass:
    ...
    def simulate(self):
        ...
        for j in range(self.par.J):
            ...
            print(f"Theoretical expected utility: {v_j:.4f}")
    ...
    def simulate_switch(self):
        ...
        chose_car_s = np.zeros((self.par.N, self.par.K), dtype=int)
    ...
    def plot_utilities_switch(self, avg_sub_expect_u_s, avg_ex_post_real_u_s):
        ...
        chose_car_i, chose_car_s, p_expect_s, real_u_s, switched_career = self.simulate_switch()
        switch_shares, avg_sub_expect_u_s, avg_ex_post_real_u_s = self.calculate_switch_metrics(chose_car_i, p_expect_s, real_u_s, switched_career)
