...
class OpenEconomyNX:
    ...
    def update_exchange_rate(self):
        ...
        self.exchange_rate += -inflation_differential
    ...
    def calculate_nx(self):
        base_nx = 0.05
        influence_factor = (self.exchange_rate * self.foreign_inflation_rate) / (self.exchange_rate * self.domestic_inflation_rate)
    ...
    def nx_simulation_economy(self, periods, shock=None, new_A=None, new_s=None, new_foreign_inflation_rate=None, new_domestic_inflation_rate=None, new_n=None, new_alpha=None, new_delta=None):
    ...
    def nx_underlying_variables(self, periods, shock, alpha=None, n=None, s=None, A=None, delta=None, 
    ...
    def nx_phase_diagram(self, alpha=None, n=None, s=None, foreign_inflation_rate=None, domestic_inflation_rate=None, delta=None):
    ...
    def interactive_underlying_variables(self, period=100, shock=0, alpha=None, n=None, s=None, r=None, A=None, delta=None, 
                     foreign_inflation_rate=None, domestic_inflation_rate=None):
        if alpha is None:
        ...
        if foreign_inflation_rate is None:
            foreign_inflation_rate = self.foreign_inflation_rate
        if domestic_inflation_rate is None:
            domestic_inflation_rate = self.domestic_inflation_rate

        interact(self.nx_underlying_variables,
                ...
                alpha=FloatSlider(min=0.1, max=0.9, step=0.01, value=alpha, description='Alpha'),
                n=FloatSlider(min=0, max=0.1, step=0.01, value=n, description='Population Growth (n)'),
                s=FloatSlider(min=0.1, max=0.4, step=0.01, value=s, description='Savings Rate (s)'),
                r=FloatSlider(min=0.01, max=0.1, step=0.01, value=r, description='Interest Rate (r)'),
                A=FloatSlider(min=0.5, max=2.0, step=0.1, value=A, description='Technology Factor (A)'),
                delta=FloatSlider(min=0.01, max=0.1, step=0.01, value=delta, description='Depreciation Rate (delta)'),
                foreign_inflation_rate=FloatSlider(min=0, max=0.1, step=0.01, value=foreign_inflation_rate, description='Foreign Inflation Rate'),
                domestic_inflation_rate=FloatSlider(min=0, max=0.1, step=0.01, value=domestic_inflation_rate, description='Domestic Inflation Rate'))
